...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(gr_draw_markers),Series,Base.OneTo{Int64},Array{Float64,1},Tuple{Float64,Float64},Int64,Int64})
    ...
    Base.precompile(Tuple{typeof(plot),Any})
    Base.precompile(Tuple{typeof(plotarea!),Subplot{GRBackend},BoundingBox{Tuple{Length{:mm,Float64},Length{:mm,Float64}},Tuple{Length{:mm,Float64},Length{:mm,Float64}}}})
    Base.precompile(Tuple{typeof(processFillArg),Dict{Symbol,Any},Bool})
